...
DinoBoard v2 把这条路径一次性打通,变成**可复用的引擎 + 可调用的 API**:
...
### ISMCTS-v2:无 chance node 的 DAG 搜索
...
| 游戏 | 玩家数 | 难点 | AI 状态 |
|------|------|------|------|
| **TicTacToe** | 2 | 最小范例 | 超越人类(游戏本身必和) |
| **Quoridor** | 2 | 长 horizon、策略性强 | 超越人类,含残局精确求解 |
| **Splendor** | 2-4 | 对称随机 + 暗牌盲预订 | 超越人类 |
| **Azul** | 2-4 | 袋中抽瓷(对称物理随机) | 超越人类 |
| **Love Letter** | 2-4 | 非对称隐藏 + 玩家淘汰 + 精确知识追踪 | 超越人类 |
| **Coup** | 2-4 | 虚张声势 + 11 阶段状态机 + 启发式 belief | 超越人类 |
...
- **ISMCTS-v2** — Root sampling + DAG + UCT2,隐藏信息游戏的原生方案,无需 chance node 机制。详见 [docs/MCTS_ALGORITHM.md](docs/MCTS_ALGORITHM.md)。
...
- **[MCTS 算法](docs/MCTS_ALGORITHM.md)** — ISMCTS-v2 的 DAG 搜索推导
